<template>
    <div class="fixed left-0 top-0 w-64 h-full bg-violet-700 p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <!-- <img src="../assets/img/Dooblo.png" alt="" class="w-8 h-8 rounded object-cover"> -->
            <span class="text-lg font-bold text-white ml-3">Dooblo</span>
        </a>
        <ul class="mt-4">
            <li class="mb-1 group active">
                <a href="#" class="flex items-center py-2 px-4 text-gray-300 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-violet-400 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
